    ...
    <div className="space-y-10">
      <Section>
        <MetricGrid className="xl:grid-cols-3 2xl:grid-cols-5">
          ...
          <MetricCard
            label="Likely owners"
            value={String(new Set(filteredFeedback.map((item) => item.owner)).size)}
          />
        </MetricGrid>
      </Section>
      ...
      <Section>
        <WorkbenchGrid>
          <div className="space-y-6">
            ...
            <TableSection
              title="Theme summary"
              description="Theme cards update immediately as filters change or new synthetic feedback is added."
              className="p-6"
            >
          ...
          <div className="space-y-6">
            <TableSection
              title="Add feedback"
              description="Paste a synthetic comment and the deterministic classifier will assign a theme, owner and metric immediately."
              className="p-6"
            >
      ...
      <TableSection
        ...
        description="Use the full-width feedback table to connect theme, severity, journey stage, accountable owner and metric to track."
      >
        <DataTable
          columns={[
            {
