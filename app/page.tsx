        ...
        <div className="px-6 py-8 lg:px-10 lg:py-10">
          <div className="max-w-5xl">
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-sky-50/90">
              DepositIQ helps banking product teams benchmark competitor deposit
              rates, model pricing scenarios, assess product complexity, measure
              primary banking behaviour, identify customer friction and prioritise
              the roadmap.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <ButtonLink href="/market-intelligence">
                Start with Market Intelligence
              </ButtonLink>
              <ButtonLink href="/pricing-simulator" tone="secondary">
